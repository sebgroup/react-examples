...
const NoMatch: React.FC = () => {
  ...
  const rootContainerStyle: React.HTMLAttributes<HTMLDivElement>["style"] = {
    position: "relative",
    display: "grid",
    gridTemplateRows: `${sidebarHeaderHeight}px calc(100vh - ${sidebarHeaderHeight *
      2}px) ${sidebarHeaderHeight}px`,
  ...
  const backgroundElementStyle: React.HTMLAttributes<
    HTMLSpanElement
  >["style"] = {
    position: "fixed",
    width: 600,
          ...
          <div className="container py-3" style={{ maxHeight: "100%" }}>
            ...
            <div className="row align-items-end">
              <div className="col-sm">
                ...
                <hr />
                <p>
                  Something like this usually happens when you accidentally
                  typed in a wrong url or we encountered something very
                  unexpected
                </p>
                <hr />
